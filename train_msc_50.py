...
from deeplab_resnet import DeepLabResNetModel_50, ImageReader, decode_labels, inv_preprocess, prepare_label
...
def main():
    ...
    with tf.variable_scope('', reuse=False):
        net = DeepLabResNetModel_50({'data': image_batch}, is_training=args.is_training, num_classes=args.num_classes)
    with tf.variable_scope('', reuse=True):
        net075 = DeepLabResNetModel_50({'data': image_batch075}, is_training=args.is_training, num_classes=args.num_classes)
    with tf.variable_scope('', reuse=True):
        net05 = DeepLabResNetModel_50({'data': image_batch05}, is_training=args.is_training, num_classes=args.num_classes)

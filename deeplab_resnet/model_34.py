...
class DeepLabResNetModel_34(Network):
    def setup(self, is_training, num_classes):
        ...
        '''
        (self.feed('data')
            .conv(3, 3, 64, 2, 2, biased=False, relu=False, name='conv1')
        ...
        (self.feed('res2a_relu',
            ...
            .conv(3, 3, 64, 1, 1, biased=False, relu=False, name='res2c_branch2a')
        ...
        (self.feed('bn3a_branch1',
            ...
            .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b1_branch2a')
        ...
        (self.feed('res3a_relu',
            ...
            .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b2_branch2a')
        ...
        (self.feed('res3b1_relu',
            ...
            .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b3_branch2a')
        ...
        (self.feed('res3b2_relu',
            ...
            .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='res4a_branch1')
            .batch_normalization(is_training=is_training, activation_fn=None, name='bn4a_branch1'))

        (self.feed('res3b3_relu')
            .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4a_branch2a')
        ...
        (self.feed('bn4a_branch1',
            ...
            .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b1_branch2a')
        ...
        (self.feed('res4a_relu',
            ...
            .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b2_branch2a')
        ...
        (self.feed('res4b1_relu',
            ...
            .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b3_branch2a')
        ...
        (self.feed('res4b2_relu',
            ...
            .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b4_branch2a')
        ...
        (self.feed('res4b3_relu',
            ...
            .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b5_branch2a')
        ...
        (self.feed('res4b4_relu',
            ...
            .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res5a_branch1')
            .batch_normalization(is_training=is_training, activation_fn=None, name='bn5a_branch1'))

        (self.feed('res4b5_relu')
            .conv(3, 3, 512, 1, 1, biased=False, relu=False, name='res5a_branch2a')
        ...
        (self.feed('res5b_relu',
            ...
            .atrous_conv(3, 3, num_classes, 2, padding='SAME', relu=False, name='fc1_voc12_c0'))

        (self.feed('res5c_relu')
            .atrous_conv(3, 3, num_classes, 4, padding='SAME', relu=False, name='fc1_voc12_c1'))

        (self.feed('res5c_relu')
            .atrous_conv(3, 3, num_classes, 8, padding='SAME', relu=False, name='fc1_voc12_c2'))

        (self.feed('res5c_relu')
            .atrous_conv(3, 3, num_classes, 16, padding='SAME', relu=False, name='fc1_voc12_c3'))

...
from deeplab_resnet import DeepLabResNetModel_50, ImageReader, decode_labels, prepare_label
...
def main():
    ...
    # Create network.
    net = DeepLabResNetModel_50({'data':image_test}, is_training=False, num_classes=args.num_classes)

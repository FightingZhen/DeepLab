...
from deeplab_resnet import DeepLabResNetModel_34, ImageReader, decode_labels, prepare_label
from deeplab_resnet import utils

IMG_MEAN = np.array((104.00698793, 116.66876762, 122.67891434), dtype=np.float32)

snapshot_dir = './DeepLab_34_tuned/'
Test_Type = "Non_Origin"
NUM_CLASSES = 2
test_batch_num = 85
if Test_Type == "Origin":
    pic_width = 648
...
def main():
    ...
    # Create network.
    net = DeepLabResNetModel_34({'data': image_test}, is_training=False, num_classes=args.num_classes)
